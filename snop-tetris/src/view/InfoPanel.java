...
public class InfoPanel extends JPanel {
     ...
     */
    private Map<Integer, TetrisControls> myInstructionMap;
    ...
    public void setControls(final Map<Integer, TetrisControls> theControlMap) {
        myInstructionMap = theControlMap;
    }
    ...
    private List<String> getTextToDraw() {
        ...
        for (final Integer keyEventCode : myInstructionMap.keySet()) {
            final String keyDescription = KeyEvent.getKeyText(keyEventCode);
            final TetrisControls control = myInstructionMap.get(keyEventCode);
